...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/mapbox_earcut-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mapbox_earcut-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add mapbox_earcut
# for installing globally
pixi global install mapbox_earcut
```
...
It is possible to list all of the versions of `mapbox_earcut` available on your platform:
...
```
pixi search mapbox_earcut --channel conda-forge
```
